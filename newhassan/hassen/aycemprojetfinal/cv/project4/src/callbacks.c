   ...
   GtkTreeModel *model;
    ...
    // Récupérer l'itérateur de la ligne sélectionnée
        ...
        // Appeler la fonction de suppression avec l'ID
               supprimer_reserv("/home/hassan/Projects/projectreservation/Rese.txt", id_reservation);
                                        ...
                                        gpointer         user_data)
{
    ...
    chercher("/home/hassan/Projects/projectreservation/Rese.txt",Id);
...
gtk_spin_button_set_value(GTK_SPIN_BUTTON(spinbuttonhdeb), res.heure_debut.heure);
...
gtk_spin_button_set_value(GTK_SPIN_BUTTON(spinbuttonminfin), res.heure_fin.minute);
